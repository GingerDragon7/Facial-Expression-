...
def kNN(X_train, y_train, X_test, y_test):
    ...
    for clas in y_test:
        ...
        total_corr += c
        i += 1
    print 'Accuracy is ', float(total_corr*5)/80*100
...
if __name__ == "__main__":
    ...
    def cross_val(X, y, DR=None, Alg=None, All=False):
        ...
        for train, test in kf:
            ...
            print '\n'
        if DR == 'PCA' and Alg == '1NN' or All:
            print 'Average accuracy for LDA + 1NN ', sum(avg_acc_p), '\n'

        if DR == 'LDA' and Alg == '1NN' or All:
            print 'Average accuracy for LDA + 1NN', sum(avg_acc_l), '\n'
    ...
    def task_selector():
        ...
        choice = int(raw_input(
                               '1: Resized Images + LDA + 1NN \n'
                               
                               'Please press 1 for LDA: '))
        print '\n'
        if choice == 2:
            ...
            print "Running Task 1: Resized Images + LDA + 1NN"
